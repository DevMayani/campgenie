  ...
  return (
   ...
   <div  style={{
    ...
    backgroundRepeat: 'no-repeat',
     ...
     <img src="/assets/campess.svg" alt="campus-essential-img"    className="w-full h-auto hidden lg:block "    />
     <img src="/assets/camp.svg" alt="campus-essential-img"    className="w-full h-auto block lg:hidden"    />
    </div>
   </div>
